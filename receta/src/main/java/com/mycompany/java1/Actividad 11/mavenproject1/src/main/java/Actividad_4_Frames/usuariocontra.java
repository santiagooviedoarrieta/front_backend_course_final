...
public class usuariocontra extends javax.swing.JFrame {
        ...
        int contrascorrect= 1234;
        String usuario2correct="random";
        int contras2correct= 0000;
    /**
    ...
    private void IngresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_IngresarMouseClicked
        ...
        if ((usuariocorrect.equals(usuario1)) && (Integer.parseInt(contraseña) == contrascorrect)) {
            int contador = 0;
            Prueba1 sec = new Prueba1(contador ) ;
            sec.setVisible(true);
           this.dispose();
        } else{
            ...
            if ((usuario2correct.equals(usuario1)) && (Integer.parseInt(contraseña) == contras2correct)){
            int contador = 1;
            Prueba1 sec = new Prueba1(contador);
            sec.setVisible(true);
        } else{
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new usuariocontra().setVisible(true);
            }
        });
    }
